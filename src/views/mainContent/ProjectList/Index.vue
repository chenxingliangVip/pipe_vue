    ...
    export default {
        ...
        methods: {
             getTableList(){//获取表格数据
                ...
                setTimeout(()=>{
                    this.tableHeader =  [
                        {"columnValue": "tableNum1", "columnName": "项目号", width: 150 },
                        {"columnValue": "tableNum2", "columnName": "项目名称",},
                        {"columnValue": "tableNum3", "columnName": "设计人", width: 150},
                        {"columnValue": "tableNum4", "columnName": "授权访问", width: 150},
                        {"columnValue": "tableNum5", "columnName": "截止日期", width: 200},
                    ]
